...
Учебный проект в рамках курса «Основы распределенных вычислений». Проект демонстрирует практическую ценность применения шардирования данных для распределения нагрузки на сервер
