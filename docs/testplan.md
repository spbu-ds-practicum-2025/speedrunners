...
*   **Результат:**
    ...
    -   **0 ошибок** (благодаря `asyncio.Lock` и очереди).
    -   Файл базы данных не блокируется "намертво" (интерфейс доступен сразу после теста).

---

## 5. Демонстрационный тест

*Сценарий для показа преподавателю.*
